...
const timelineItems = createTimeline(
  ...
  return (
    <div style={page} className="compact-client-page">
      <Sidebar />

      <style jsx global>{`
        .compact-client-main h2 {
          margin-top: 0;
          margin-bottom: 12px;
          font-size: 19px;
          line-height: 1.2;
        ...
        .compact-client-main p {
          margin: 5px 0;
        }

        .compact-client-main textarea {
          resize: vertical;
        }
      `}</style>

      <main style={main} className="compact-client-main">
        <div style={header}>
          <div>
